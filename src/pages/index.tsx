  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Streamlining your dining experience with seamless table reservations and efficient menu management, all at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Streamlining your dining experience with seamless table reservations and efficient menu management, all at your fingertips.`}
            </Text>
            <Box
